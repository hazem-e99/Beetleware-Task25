...
export function BoostingBusinessCard({ data, delay = 0.2, className }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ delay }}
      className={cn("bg-card border border-border rounded-3xl p-5 sm:p-6 md:p-8", className)}
    >
      <div className="text-center mb-4 sm:mb-6 md:mb-8 flex flex-col items-center">
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-[20px] text-textP w-full sm:w-4/5 md:w-3/4">
