...
export function PricingCard({ plan, index }) {
  return (
    <motion.div
      ...
      className="relative border border-pricingCardBorder bg-bgPricingCard rounded-2xl p-8 md:p-10 lg:p-12 transition-all duration-300 hover:shadow-card-hover flex flex-col justify-between"
    >
      {plan.isPopular && (
        <div className="absolute top-5 right-4 border border-[#33C6AB] rounded-full">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="text-sm text-textP mb-4">{plan.description}</p>
        <div className="flex items-baseline gap-1 justify-center py-8 sm:py-12 md:py-14 lg:py-16 px-4 sm:px-8 md:px-12 lg:px-[83.87px]">
      ...
      <ul className="space-y-1 mb-8 flex flex-col justify-start min-h-[240px] sm:min-h-[280px] md:min-h-[320px]">
